...
export default function AboutPage() {
  ...
  return (
    <div className="bg-background min-h-screen pb-32">
      ...
      {/* 1. HERO SECTION */}
      <div className="pt-40 pb-16 text-center container-base">
      ...
      {/* 2. CONTACT INFO BAR */}
      <div className="container-base mb-32 flex justify-center px-4">
      ...
      <div className="container-base mb-32 max-w-6xl">
         <h2 className="sr-only">Our Core Advantages</h2>
