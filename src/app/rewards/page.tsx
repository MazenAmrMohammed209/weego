...
export const metadata = {
  title: "My Rewards | WEEGO",
  description: "Manage your WEEGO loyalty points and explore premium benefits.",
};
      ...
      <div className="container-base">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-12 mt-8">
          <div className="max-w-xl">
            ...
            <p className="text-lg text-foreground/70">
              Welcome back! Here is a summary of your loyalty points, current tier benefits, and upcoming rewards.
            </p>
          </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          <div className="lg:col-span-2 rounded-3xl bg-primary p-8 sm:p-12 text-white relative overflow-hidden flex flex-col justify-center">
            ...
            <div className="relative z-10 flex items-center gap-3 mb-6">
              ...
              <span className="text-lg font-medium text-primary-foreground/80">Available Points</span>
            </div>
            <div className="relative z-10 text-6xl sm:text-7xl font-bold tracking-tight mb-2">
              12,450 <span className="text-2xl font-medium text-accent">pts</span>
            </div>
            <div className="relative z-10 mt-8">
              ...
              <p className="text-sm text-primary-foreground/70">
                You are 2,550 points away from <strong className="text-white">Gold Tier</strong>!
              </p>
            </div>
          </div>
          ...
          <div className="rounded-3xl border border-border bg-background p-8 sm:p-12 flex flex-col items-center justify-center text-center shadow-sm">
            ...
            <h3 className="text-xl font-bold text-foreground mb-1">Silver Tier</h3>
            <p className="text-sm text-foreground/70 mb-6">Current Member Status</p>
            <Link
              href="#benefits"
        ...
        <div className="rounded-3xl border border-border bg-background shadow-sm p-8 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="text-lg font-bold text-foreground">Ready for a getaway?</h4>
              <p className="text-sm text-foreground/70 mt-1">
                You have enough points to redeem a free internal flight or a 2-night luxury hotel stay.
              </p>
            </div>
          </div>
