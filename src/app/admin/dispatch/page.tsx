...
export default function AdminDispatchPage() {
  const needsAssignment = [
    { id: "BKG-9922", pass: "Sarah Williams", tier: "Corporate", route: "Maadi → Smart Village", time: "16:00 (In 2 hrs)", urgency: "Medium" },
    { id: "BKG-9925", pass: "John Doe", tier: "Premium", route: "Cairo Airport → Four Seasons", time: "14:45 (In 45 mins)", urgency: "High" },
    { id: "BKG-9928", pass: "Ali Hassan", tier: "Standard", route: "New Cairo → Zamalek", time: "18:00 (In 4 hrs)", urgency: "Low" },
  ];

  const availableDrivers = [
    { name: "Ahmed Fathy", vehicle: "Mercedes S-Class (AB-123)", dist: "2.5 km away", status: "Available" },
    { name: "Kareem Said", vehicle: "BMW 7 Series (XY-987)", dist: "5.1 km away", status: "Finishing Trip" },
    { name: "Omar Nabil", vehicle: "Mercedes V-Class (KL-555)", dist: "7.8 km away", status: "Available" },
  ];
