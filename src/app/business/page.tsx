        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start max-w-7xl mx-auto">
          ...
          <div className="bg-bg-light dark:bg-[#111822] rounded-[2rem] p-8 md:p-10 border border-border shadow-[0_8px_30px_rgba(0,0,0,0.1)] relative overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
              ...
              <button
                type="submit"
                className="w-full bg-[#0c1622] hover:bg-[#1a2531] dark:bg-[#0a1017] dark:hover:bg-[#111822] text-white border border-border/50 font-bold text-sm tracking-wider uppercase py-4 rounded-xl transition-all shadow-md active:scale-[0.98]"
              >
