    ...
    <section className="py-24 bg-background overflow-hidden">
      <div className="container-base grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
           ...
           <div className="absolute inset-0 bg-gradient-to-b from-transparent to-primary/10 mix-blend-multiply" />
           <div className="absolute w-[150%] h-[150%] bg-[conic-gradient(at_top_right,_var(--tw-gradient-stops))] from-accent/20 via-primary/5 to-background rounded-full blur-3xl opacity-50 group-hover:opacity-70 transition-opacity duration-700 -top-[50%] -right-[50%]" />
           
           <Car className="h-40 w-40 text-primary/20 dark:text-primary-foreground/20 relative z-10 transition-transform duration-700 group-hover:scale-110" />
           <div className="absolute bottom-10 left-10 right-10 p-6 bg-background/80 backdrop-blur-xl border border-border rounded-2xl">
